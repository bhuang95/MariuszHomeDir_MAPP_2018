...
file_bckg_in='/scratch3/BMC/chem-var/pagowski/enkf_runs/trunk_r79009/fix/Big_Endian/global_berror.l63y386.f77'

file_bckg_out=global_berror.l63y386_aero_gocart.f77
