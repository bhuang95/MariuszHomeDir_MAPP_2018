...
C
        ...
        CHARACTER * 6   HHNAM128(50)
        CHARACTER * 6   HHNAM129(69)
        CHARACTER * 6   HHNAM130(75)
        CHARACTER * 6   HHNAM131(241)
        CHARACTER * 4   HHHNAM(71)
        CHARACTER * (*) IPDS 
        CHARACTER * 8   IPDS0
        CHARACTER * 28  IDPDS
        CHARACTER * 4   GRIB
...
C
     ...
     &               157, 158, 159, 160, 161, 165, 170,
     &               171, 172, 173, 175, 176, 177, 178,
     &               179, 180, 181, 182, 183, 184, 185,
     &               186, 187, 188, 190, 192, 193, 194,
     &               254/
        DATA  HHNAM128/
     &'      ','      ','      ','      ','      ','      ','      ',
     &'      ','      ','      ','      ','      ','      ','      ',
     ...
     &'      ','      ','      ','      ','      ','      ','      ',
     &'      ','      ','      ',' TMIX ','      ','      ','      ',
     &'      ',' ASHFL',' ASSFL',' BOTLD',' UBARO',' VBARO',' INTFD',
     &' WTMPC',' SALIN',' EMNP ',' KENG ',' LAYTH',' SSTT ',' SSST ',
     &'      '/
C
...
C
     ...
     &               200, 201, 202, 210, 211, 212/
        DATA  HHNAM129/
     &' PAOT ',' PAOP ',' FRAIN',' FICE ',' FRIME',' CUEFI',' TCOND',
     &' TCOLW',' TCOLI',' TCOLR',' TCOLS',' TCOLC',' PLPL ',' HLPL ',
     &' CEMS ',' COPD ',' PSIZ ',' TCWAT',' TCICE',' WDIF ',' WSTP ',
     &' PTAN ',' PTNN ',' PTBN ',' PPAN ',' PPNN ',' PPBN ',' PMTC ',
     &' PMTF ',' AETMP',' AEDPT',' AESPH',' AEUWD',' AEVWD',' LPMTF',
     &' LIPMF',' REFZR',' REFZI',' REFZC',' TCLSW',' TCOLM',' ELRDI',
     &' TSEC ',' TSECA',' NUM  ',' AEPRS',' ICSEV',' ICPRB',' LAVNI',
     &' HAVNI',' OZCON',' OZCAT',' VEDH ',' SIGV ',' EWGT ',' USCT ',
     &' VSCT ',' TCHP ',' DBSS ',' ODHA ',' OHC  ',' SSHG ',' SLTFL',
     &' DUVB ',' CDUVB',' THFLX',' REFO ',' REFD ',' REFC '/
C
...
C
     ...
     &               183, 184, 187, 188, 198, 199, 200,
     &               203, 204, 205, 207, 208, 210, 211,
     &               212, 219, 220, 222, 223, 224, 225,
     &               226, 227, 228, 229, 230, 231, 234,
     &               235, 238, 239, 240, 246, 247, 248,
     &               249, 252, 253, 254, 255/
        DATA  HHNAM130/
     &' SOILW',' PEVPR',' VEGT ',' BARET',' AVSFT',' RADT ',' SSTOR',
     &' LSOIL',' EWATR',' LSPA ',' GFLUX',' CIN  ',' CAPE ',' TKE  ',
     &'MXSALB',' SOILL',' ASNOW',' ARAIN',' GWREC',' QREC ',' SNOWT',
     &' VBDSF',' VDDSF',' NBDSF',' NDDSF','SNFALB',' RLYRS',' M FLX',
     &' NLAT ',' ELON ','FLDCAP',' ACOND',' SNOAG',' CCOND',' LAI  ',
     &' SFCRH',' SALBD',' NDVI ',' DRIP ',' SBSNO',' EVBS ',' EVCW ',
     &' RSMIN',' DSWRF',' DLWRF',' MSTAV',' SFEXC',' TRANS',' USWRF',
     &' ULWRF',' WILT ',' FLDCP',' SLTYP',' CNWAT',' SOTYP',' VGTYP',
     &' BMIXL',' AMIXL',' PEVAP',' SNOHF',' SMREF',' SMDRY',' BGRUN',
     &' SSRUN',' SNOWC',' SNOT ',' POROS',' RCS  ',' RCT  ',' RCQ  ',
     &' RCSOL',' CD   ',' FRICV',' RI   ',' MISS '/
C
...
C       NUMBER 1 OR 2 OR 128, 129 OR 130 OR 131
C
