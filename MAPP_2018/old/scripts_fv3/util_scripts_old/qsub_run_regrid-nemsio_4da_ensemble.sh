...
#qsub -v ident=2015081006 qsub_run_regrid-nemsio_4da_ensemble.sh
...
workdir=${BASEDIR}/workdir_nemsio_regrid_ensemble
...
INDIR_FV3=${FV3_RUNS}/DA_ENKF/${analdate}/OUTPUT_FV3/${charnanal}
OUTDIR=${FV3_RUNS}/DA_ENKF/${analdate}/OUTPUT_FV3_nemsio/${charnanal}
