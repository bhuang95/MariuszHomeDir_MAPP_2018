...
#qsub -v ident=2015080606 qsub_run_regrid-nemsio_4da.sh
...
INDIR_FV3=${FV3_RUNS}/DA_GSI/${analdate}/OUTPUT_FV3
OUTDIR=${FV3_RUNS}/DA_GSI/${analdate}/OUTPUT_FV3_nemsio
