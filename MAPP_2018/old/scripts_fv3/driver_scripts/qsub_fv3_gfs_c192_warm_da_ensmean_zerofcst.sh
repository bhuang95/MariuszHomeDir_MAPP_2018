...
#qsub -v ident=2015080406 qsub_fv3_gfs_c192_warm_da_ensmean_zerofcst.sh

member='ensmean'

start_ident=2015080100
end_ident=2015081000
...
/bin/cp ${SCRIPTDIR_DRIVER}/diag_table_da_gocart_old_zero diag_table
...
/bin/mv ${adate}.fv3_history.tile?.nc diag_table field_table fms.out input.nml logfile.000000.out time_stamp.out $OUTDIR
