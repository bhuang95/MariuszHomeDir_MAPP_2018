...
export OBS_DIR=${MAINDIR}/OBS

export GFS_DIR=${MAINDIR}/GFS/indata_spectral
export GFS_DIR_ENS=${MAINDIR}/GFS/indata_spectral_ensemble

#export FV3_BASEDIR=${BASEDIR}/sorc/fv3gfs.fd
#export FV3_EXECDIR=${FV3_BASEDIR}/NEMS/exe
#export FV3_EXEC=fv3_gfs_nh.prod.32bit.x

export FV3_BASEDIR=${MAINDIR}/fv3_phil/trunk_orig/FV3
...
export MY_EXECDIR=${MAINDIR}/MY_EXECS
