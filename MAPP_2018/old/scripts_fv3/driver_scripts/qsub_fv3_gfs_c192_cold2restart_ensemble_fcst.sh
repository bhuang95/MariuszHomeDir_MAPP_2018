...
#qsub -v ident=2015080100 qsub_fv3_gfs_c192_cold2restart_ensemble_fcst.sh
#only to obtain RESTART for ensmbles because of missing GFS on 2015080312
...
OUTDIR=${FV3_RUNS}/${sim_restart}/${analdatep}
