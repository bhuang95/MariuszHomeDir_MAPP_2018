...
GOCART_EMISS_DATA=${FV3_BASEDIR}/EMISS_DATA/EDGAR
GOCART_EMISS_DIR=${FV3_BASEDIR}/sorc/fv3gfs.fd/DA_gocart_emiss_new/inbound
GOCART_EMISS_EXEC_DIR=${GOCART_EMISS_DIR}/BUILD/bin
GOCART_EMISS_EXEC=fv3_gocart_emiss_edgar_anthro_32bit.x
...
ln -sf ${grid}/* ./INPUT
ln -sf ${GOCART_EMISS_DATA}/emiss_edgar_anthro_fv3_subset.nc ./INPUT/emiss_edgar_anthro_fv3.nc
...
src_file=emiss_edgar_anthro_fv3.nc
dst_file=emiss_edgar_anthro.tile1.nc
