...
#qsub -v ident=2015081000 qsub_fv3_gfs_c192_cold2restart_ensemble.sh
...
enkfdir=${FV3_RUNS}/DA_ENKF/${analdate}
gfsindir=${enkfdir}/INPUT_cold/${charnanal}
grid=${FV3_DATA}/${resolution}/grid 
clim=${FV3_CLIM}
OUTDIR=${enkfdir}/RESTART_cold/${charnanal}
WORKDIR=${FV3_BASEDIR}/workdir_cold_ensemble
...
/bin/cp ${SCRIPTDIR}/diag_table_zero diag_table
...
# Date specific ICs
ln -sf ${FV3_RUNS}/DA_ENKF/gfs_ctrl.nc ./INPUT
itile=1
while [[ $itile -le 6 ]]
do
