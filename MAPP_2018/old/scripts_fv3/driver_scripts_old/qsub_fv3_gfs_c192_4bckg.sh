...
#qsub -v ident=2015080100 qsub_fv3_gfs_c192_4bckg.sh
...
/bin/cp ${SCRIPTDIR}/diag_table_warm_4bckg diag_table
/bin/cp ${SCRIPTDIR}/field_table_tracers field_table
...
then
    cd $SCRIPTDIR
    echo "qsub -v ident=$ident qsub_fv3_gfs_c192_4bckg.sh"
    qsub -v ident=$ident qsub_fv3_gfs_c192_4bckg.sh
