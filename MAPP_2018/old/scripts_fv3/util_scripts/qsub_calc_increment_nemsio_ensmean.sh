...
file_fcst=${FV3_RUNS}/${sim}/${analdatem}/ensmean/OUTPUT_FV3_nemsio/sfg_${analdate}_fhr06
file_anal=${FV3_RUNS}/${sim}/${analdate}/ensmean/OUTPUT_GSI_nemsio/siganl_${analdate}
file_nc_in=${FV3_FIXDIR}/C${RES}/fv3_increment_zero.nc

OUTDIR=${FV3_RUNS}/${sim}/${analdate}/ensmean/OUTPUT_increment
