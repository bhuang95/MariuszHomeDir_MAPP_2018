...
while [[ ${current_day} -le ${last_day} ]]
    ...
    htar -xvf ${ncepdir}/com_gfs_prod_enkf.${YYYYMMDD}_${HH}.fcs03.tar "./*_ensmean"
    htar -xvf ${ncepdir}/com_gfs_prod_enkf.${YYYYMMDD}_${HH}.fcs.tar "./*_ensmean"
    htar -xvf ${ncepdir}/com_gfs_prod_enkf.${YYYYMMDD}_${HH}.fcs00.tar "./*_ensmean"
