...
#qsub -v ident=2015080100 qsub_run_regrid-nemsio_4da.sh
...
INDIR_FV3=${FV3_RUNS}/${sim}/${analdate}/OUTPUT_FV3
OUTDIR=${FV3_RUNS}/${sim}/${analdate}/OUTPUT_FV3_nemsio
...
workdir=${MAINDIR}/tmp_dirs/workdir_nemsio_regrid
/bin/rm -rf $workdir
mkdir -p $workdir
...
echo "qsub -v ident=$ident qsub_gsi_fv3_aod_nnr.ksh"
qsub -v ident=$ident qsub_gsi_fv3_aod_nnr.ksh
