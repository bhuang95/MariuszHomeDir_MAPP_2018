...
OUTDIR=/scratch3/BMC/chem-var/pagowski/tmp/FV3GFS/GFS/indata_spectral_ensemble
...
while [[ ${current_day} -le ${last_day} ]]
    ...
    htar -xvf ${ncepdir}/com_gfs_prod_enkf.${YYYYMMDD}_${HH}.anl.tar "./*_mem00?"
    htar -xvf ${ncepdir}/com_gfs_prod_enkf.${YYYYMMDD}_${HH}.anl.tar "./*_mem01?"
    htar -xvf ${ncepdir}/com_gfs_prod_enkf.${YYYYMMDD}_${HH}.anl.tar "./*_mem020"
