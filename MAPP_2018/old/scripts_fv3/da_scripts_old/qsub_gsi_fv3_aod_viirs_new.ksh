...
#qsub -v ident=2015081012 qsub_gsi_fv3_aod_viirs_new.ksh
...
#TBD
  ...
  BK_ROOT=${FV3_RUNS}/DA_GSI/${analdatem}/OUTPUT_FV3_nemsio

  CRTM_ROOT=${GSI_ROOT}/crtm_coeffs
  FIX_ROOT=${GSI_ROOT}/fix
  GSI_EXE=${GSI_EXEC}
  GSI_NAMELIST=${SCRIPTDIR_DA}/namelist_gsi_fv3_aod_viirs_new.sh
...
if [ -s ./sfcf03 ] && [ -s ./sfcf06 ] && [ -s ./sfcf09 ] && [ -s ./sigf03 ] && [ -s ./sigf06 ] && [ -s ./sigf09 ] ; then
    ...
    OUTDIR=${FV3_RUNS}/DA_GSI/${analdate}/OUTPUT_GSI_nemsio
