MODULE ufo_misc
  ...
  CHARACTER(len=max_name_length) :: aerostring='aerosols'
...
CONTAINS
  ...
  SUBROUTINE get_names(obs,model,table,nvars,allnames,&
    ...
    CHARACTER(max_string_length), INTENT(in) :: table
    INTEGER, INTENT(inout) :: nvars
    CHARACTER(max_name_length), DIMENSION(max_vars), INTENT(inout) :: &
         &allnames

    CHARACTER(max_string_length), OPTIONAL, INTENT(in) :: aerosoltable
