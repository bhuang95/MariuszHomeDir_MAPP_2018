...
module llxy_module
  ...
  ! BUG: Implement this projection.
   ...
   ! Purpose:
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  
   SUBROUTINE lltoxy(proj,xlat, xlon, x, y, stagger, comp_ll)
      ...
      call latlon_to_ij(proj, xlat, xlon, x, y)
   ...
   ! Purpose:
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  
   SUBROUTINE xytoll(proj,x, y, xlat, xlon, stagger, comp_ll)
      ...
      call ij_to_latlon(proj, rx, ry, xlat, xlon)
