...
contains
  ...
  subroutine read_wrf_arw_aero(filename,nx,ny,nz,num_aeros,aero)
   implicit none

   character(len=*), intent(in)      :: filename
   integer, intent(in)      :: nx, ny, nz

!   real       :: sf(1:nx,1:ny,1:nz)
!   real       :: vp(1:nx,1:ny,1:nz)
!   real       :: t(1:nx,1:ny,1:nz)
!   real       :: q(1:nx,1:ny,1:nz)
!   real       :: qm(1:nx,1:ny,1:nz)
!   real       :: p(1:nx,1:ny)
