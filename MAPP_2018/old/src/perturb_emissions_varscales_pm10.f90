PROGRAM perturb_emissions_varscales_pm10
...
! no sectors for pm10 - lenghtscale calculated for all sectors together
...
!recursive filter parameters
  ...
  character name*31
  INTEGER, PARAMETER :: naero=1,varname_length=12
...
END PROGRAM perturb_emissions_varscales_pm10
