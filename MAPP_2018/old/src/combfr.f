...
C USAGE:
C   INPUT FILES:
C     UNIT 55  - changed to 55 because of screw-up of the original
...
C$$$
      ...
      PARAMETER (NFILES=200)  ! Number of input files being considered
...
C         READ(5,'(A)',END=1) THIS_FILI
         READ(55,'(A)',END=1) THIS_FILI
