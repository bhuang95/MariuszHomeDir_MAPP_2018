...
MODELDIR=${EXPDIR}/${sim}/dr-data-longfcst-backup
...
OUTDIR=${EXPDIR}/${sim}/viirs_aod_longfcst
...
do
	...
	fv3indir=${MODELDIR}/gdas.${yyyymmdd}/${hour}/diag/aod_grid/FV3AOD_fv_tracer_${ident}_fhr${cfcsthour}

	outdir=${OUTDIR}/${ident}/fhr${cfcsthour}
	outfile=${outdir}/VIIRS_AOD_npp_fcst.${fyyyymmddhh}.nc
...
&record_fv3_input
 ...
 fname_fv3="${fyear}${fmonth}${fday}.${fhour}0000.fv_aod_LUTs.fv_tracer.res.tile?.nc"
/
&record_viirs_inout
