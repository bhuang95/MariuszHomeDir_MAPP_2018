...
#SBATCH -o /scratch3/BMC/fim/Mariusz.Pagowski/FV3_CHEM/qslogs/%x.o%j
#SBATCH -e /scratch3/BMC/fim/Mariusz.Pagowski/FV3_CHEM/qslogs/%x.e%j
...
OUTDIR=/scratch3/BMC/fim/Mariusz.Pagowski/FV3_CHEM/INOUTDATA
