...
if __name__ == '__main__':
    ...
    #loc_mdata['frequency'] = np.array(frequency)
    #loc_mdata['wavelength'] = np.array(aod_wav_m)
    #loc_mdata['sensor_channel'] = np.array(aod_chan)
    #units['wavelength'] = 'm'
    ...
    if aod_new_wav is not None:
        ...
        outdata[varDict['aerosol_optical_depth_9']['errKey']] = outdata[varDict['aerosol_optical_depth_4']['errKey']]
