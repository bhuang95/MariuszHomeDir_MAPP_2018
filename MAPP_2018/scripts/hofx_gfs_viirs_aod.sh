...
do
	...
	modeldir=${MODELDIR}/gdas.${yyyymmdd}/${hour}
	aoddir=${modeldir}/diag/aod_grid/FV3AOD_fv_tracer_${ident}_fhr${cfcsthour}
	...
	aodfiles=${datefv3}.fv_aod_LUTs.fv_tracer.res
