...
start_date=2019080706
end_date=2019080800

start_date=2019080806
end_date=2019080900
...
maindir_obs=${maindir}/DATA/OBS/NUCAPS
prefix=NUCAPS-EDR_v2r0_j01
...
do
    ...
    indir_obs=${maindir_obs}/${year}${month}
    outdir_obs=${maindir_obs}/thinned_${grid}/${year}${month}
    ...
    echo $datem $datep $fdate

    while [[ $fdate -le $datep ]]
    do
	for infile_obs in ${indir_obs}/${prefix}_s${fdate}*nc 
	do
	    echo $infile_obs
	    if [[ -s $infile_obs ]]
	    then
