...
#sbatch --export=ALL sbatch_convert_c96_c384.sh
...
/bin/cp ${JEDIYAML}/convertstate_gfs_aero_c96_c384_template.yaml .
...
do
    ...
    INDIR=${MAINDIR}/outputs
    OUTDIR=${MAINDIR}/outputs_comp
    ...
    sed -e "s/analdate/${analdate}/g" convertstate_gfs_aero_c96_c384_template.yaml > convertstate_gfs_aero_c96_c384.yaml
	
    export jobtype=convertstate_gfs_aero_c96_c384
