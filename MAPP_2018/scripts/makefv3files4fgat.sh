...
OUTDIR=/scratch1/BMC/wrf-chem/pagowski/MAPP_2018/envar_2018/C12/RESTART4fgat/gfs_aero_c12

member=mem008 #"bkg" #mem001 #"bkg"
...
#	    ncatted -O -a history,global,d,, $OUTDIR/${member}/${year}${month}${day}.${hour}.fv_core.res.tile${itile}.nc
	...
	/bin/cp ${year_m}${month_m}${day_m}.${hour_m}.fv_tracer.res.tile${itile}.nc  $OUTDIR/${member}/${year_mm}${month_mm}${day_mm}.${hour_mm}.fv_tracer.res.tile${itile}.nc
	...
	/bin/cp ${year_m}${month_m}${day_m}.${hour_m}.fv_core.res.tile${itile}.nc  $OUTDIR/${member}/${year_mm}${month_mm}${day_mm}.${hour_mm}.fv_core.res.tile${itile}.nc
