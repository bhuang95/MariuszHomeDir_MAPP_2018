...
#sbatch --export=ALL sbatch_calc_ensmean_fv3.sh
...
INDIR=/scratch1/BMC/gsd-fv3-dev/MAPP_2018/pagowski/jedi/data/fv3-jedi/inputs/gfs_aero_c12_new
...
do
    ...
    if [[ $itile == 1 ]] then
	/bin/cp ${INDIR}/mem001/${adate}.${hour}0000.coupler.res ${INDIR}/ensmean_test
    fi
