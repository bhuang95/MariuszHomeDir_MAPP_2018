MODULE module_constants
  ...
  INTEGER(int32), PARAMETER :: MAXVARLEN=100, max_string=800,nvarmax=50
  INTEGER(int32), PARAMETER :: max_varname_length=MAXVARLEN, &
       &max_string_length=max_string, date_string_length=20
  INTEGER(int32), PARAMETER :: n_maxabsorbers=3,n_maxchannels=50,n_maxlevels=50

  INTEGER(int32), PARAMETER :: imissing=-99999
