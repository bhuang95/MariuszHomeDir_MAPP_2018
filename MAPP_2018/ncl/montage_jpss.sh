...
do
    ...
    montage ${MAINDIR}/process/a.png ${MAINDIR}/process/b.png ${MAINDIR}/process/d.png ${MAINDIR}/process/e.png -tile 2x2  -geometry 400x seas_dust_${ident}.png

    /bin/mv seas_dust_${ident}.png ${MAINDIR}/pics_4movie_jpss
