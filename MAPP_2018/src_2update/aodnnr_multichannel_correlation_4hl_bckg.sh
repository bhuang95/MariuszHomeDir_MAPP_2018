...
maindir_model_old=/scratch3/BMC/wrf-chem/pagowski/tmp/fv3GFS_old
maindir_model=/scratch3/BMC/chem-var/pagowski/tmp/FV3GFS
outdir=${maindir_obs}/4hl_${test}_${fcst_hour}
...
do
    ...
    indir_model=${maindir_model_old}/FV3_RUNS/${test}/${ident}/OUTPUT_FV3
...
!    ln -sf ${indir_model}/aod_${ident}.tile?_${fcst_hour}.nc .
